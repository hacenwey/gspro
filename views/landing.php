...
$TR = [
    'ar' => [
        ...
        'faq1_a' => 'تواصل معنا عبر واتساب، وينشئ فريقنا مساحة عملك ويرافقك خلال تجربة مجانية. لا حاجة لبطاقة بنكية — جرّب المنصة بالكامل قبل أي التزام.',
        'faq2_q' => 'ماذا يحدث بعد التجربة المجانية؟',
        'faq2_a' => 'في نهاية التجربة، يتواصل معك فريقنا عبر واتساب لتفعيل اشتراكك حسب الباقة التي تختارها. وإذا قررت عدم المتابعة، لا يُخصم منك أي مبلغ.',
        'faq3_q' => 'هل يمكنني التوقف في أي وقت؟',
        'faq3_a' => 'نعم، دون أي التزام. لا نسجّل أي بطاقة بنكية مسبقاً: أنت من يقرر مواصلة الاشتراك أو التوقف في نهاية التجربة، ويمكنك التواصل مع فريقنا عبر واتساب في أي وقت.',
    ...
    'fr' => [
        ...
        'faq1_a' => 'Contactez-nous sur WhatsApp : notre équipe crée votre espace et vous accompagne pendant un essai gratuit. Aucune carte bancaire requise — testez toute la plateforme avant tout engagement.',
        'faq2_q' => 'Que se passe-t-il après l\'essai gratuit ?',
        'faq2_a' => 'À la fin de l\'essai, notre équipe vous contacte sur WhatsApp pour activer votre abonnement selon la formule choisie. Si vous décidez de ne pas continuer, rien ne vous est facturé.',
        'faq3_q' => 'Puis-je arrêter à tout moment ?',
        'faq3_a' => 'Oui, sans aucun engagement. Aucune carte n\'est enregistrée à l\'avance : c\'est vous qui décidez de continuer ou non à la fin de l\'essai, et vous pouvez joindre notre équipe sur WhatsApp à tout moment.',
    ...
    'en' => [
        ...
        'faq1_a' => 'Contact us on WhatsApp: our team sets up your workspace and guides you through a free trial. No bank card required — test the whole platform before any commitment.',
        'faq2_q' => 'What happens after the free trial?',
        'faq2_a' => 'At the end of the trial, our team contacts you on WhatsApp to activate your subscription on the plan you choose. If you decide not to continue, you are not charged.',
        'faq3_q' => 'Can I stop at any time?',
        'faq3_a' => 'Yes, with no commitment at all. No card is stored upfront: you decide whether to continue at the end of the trial, and you can reach our team on WhatsApp at any time.',
